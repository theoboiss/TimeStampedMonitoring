...
public class Mainapp extends MainappSettings {
	...
	public static void main(String[] args) {
		 ...
		 * 
		 * try { companyToSave = new Company(); Department A = new
		 * Department("PolyGame"); Department B = new Department("JavaTech", new
		 * Employee("default", "RH")); companyToSave.addDepartment(A);
		 * companyToSave.addDepartment(B);
		 * 
		 * //add few checks to A
		 * 
		 * CheckInOut exempleCheck1 = new CheckInOut(); exempleCheck1.setEmployeeID(1);
		 ...
		 * exempleCheck2.setEmployeeID(1); CheckInOut exempleCheck3 = new CheckInOut();
		 ...
		 * SearchInMainapp.searchEmployee(B,"Theo","default").get(0).setLastname(
		 * "Boisseau"); } catch (Exception e) { System.out.println(e.getMessage()); };
		 * 
